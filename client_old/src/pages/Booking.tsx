...
import StaticBookingForm from "@/components/StaticBookingForm";
import { shouldUseStaticComponents } from "@/lib/environment";
...
export default function Booking() {
  ...
  // Check if we should use the static version without API
  useEffect(() => {
    async function checkEnvironment() {
      const shouldUseStatic = await shouldUseStaticComponents();
      setUseStaticVersion(shouldUseStatic);
    }
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        {useStaticVersion ? (
          // Static version for deployments without backend API
          ...
          // Dynamic version for development environment with backend API
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-12">
