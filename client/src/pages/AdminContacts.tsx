                ...
                <div className="space-y-7">
                  <div className="space-y-4">
                    <div className="flex items-center mb-2">
                      <svg className="h-4 w-4 text-primary mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                    ...
                    <div className="relative">
                      <Select value={timeFilter} onValueChange={setTimeFilter}>
                        <SelectTrigger className="bg-white/80 dark:bg-gray-800/60 border-gray-100 dark:border-gray-700/50 focus:ring-2 focus:ring-primary/30 shadow-sm h-10">
                          <div className="flex items-center">
                            <svg className="h-4 w-4 mr-2 text-primary/70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                        ...
                        <CardHeader className="pb-3 border-b border-gray-100/50 dark:border-gray-800/50">
                          <div className="flex flex-col sm:flex-row justify-between items-start gap-3">
                                ...
                                <div className="flex flex-col md:flex-row mt-2 gap-5">
                                  <div className="flex items-center text-sm text-text-secondary/80">
                                    <div className="p-1 rounded-full bg-primary/5 mr-2 shadow-inner">
                                      <svg className="h-3.5 w-3.5 text-primary/70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                    </div>
                                  ...
                                  {contact.phone && (
                                    <div className="flex items-center text-sm text-text-secondary/80">
                                      <div className="p-1 rounded-full bg-primary/5 mr-2 shadow-inner">
                                        <svg className="h-3.5 w-3.5 text-primary/70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                      </div>
                            ...
                            <div className="flex items-center mt-2 sm:mt-0 px-3 py-1.5 text-sm text-text-secondary bg-primary/10 backdrop-blur-sm rounded-full shadow-inner">
                              <svg className="h-4 w-4 mr-2 text-primary/70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
