...
export default function HeroSectionOriginal() {
  ...
  return (
    <section 
      ref={heroRef}
      className="relative min-h-[80vh] sm:min-h-[85vh] lg:min-h-[90vh] flex items-center justify-center w-full max-w-full overflow-x-hidden bg-gradient-radial from-[#50c2b9]/10 via-background to-background"
    >
      {/* Background elements */}
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto relative z-10 py-8 sm:py-12 md:py-16 lg:py-20 box-border">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center w-full min-w-0">
          ...
          <div className={`order-2 lg:order-1 text-center lg:text-left min-w-0 w-full transition-all duration-700 ease-out ${
            ...
            {/* Badge */}
            <div className={`inline-flex items-center mb-4 sm:mb-6 glass-effect px-5 py-2.5 text-primary rounded-full text-sm font-medium relative overflow-hidden group mx-auto lg:mx-0 transition-all duration-500 delay-200 ${
            ...
            {/* Main Heading */}
            <h1 className={`text-4xl sm:text-5xl lg:text-6xl font-bold text-text-primary leading-[1.15] mb-4 sm:mb-6 tracking-tight transition-all duration-700 delay-300 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}>
            ...
            {/* Description */}
            <p className={`text-lg text-text-secondary max-w-2xl mb-6 sm:mb-8 mx-auto lg:mx-0 transition-all duration-700 delay-500 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}>
            ...
            {/* Credentials */}
            <div className={`flex flex-wrap gap-6 justify-center lg:justify-start mt-6 text-sm text-text-secondary transition-all duration-700 delay-900 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}>
