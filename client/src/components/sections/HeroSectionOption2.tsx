          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <svg className="relative z-10 ml-2 h-5 w-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </Link>
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <div className="p-2 glass-effect rounded-full shadow-md hover:shadow-lg transition-all duration-300">
            <svg className="h-6 w-6 text-primary animate-bounce-slow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3"/></svg>
          </div>
        </div>
      </motion.div>
    </section>
