...
const CheckCircleIcon = () => (<svg className="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>);
const ChevronRightIcon = () => (<svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7"/></svg>);
                ...
                <div className="calendar-container mb-4">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-7 gap-1 text-center">
                      <div className="text-gray-600 p-2">28</div>
                      <div className="text-gray-600 p-2">29</div>
                      <div className="text-gray-600 p-2">30</div>
                      <div className="p-2">1</div>
                      <div className="p-2">2</div>
                      <div className="p-2">3</div>
                      <div className="p-2">4</div>
                      <div className="text-gray-600 p-2">5</div>
