                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {slots.map((time) => (
                        <motion.div
                          ...
                          whileTap={{ scale: 0.98 }}
                        >
                          <svg className="w-4 h-4 mr-2 ${selectedTime === time ? 'text-white' : 'text-primary'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                          <span>{time}</span>
