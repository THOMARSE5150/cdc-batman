...
export default function PageHeader({ title, description }: PageHeaderProps) {
  return (
    <div className="relative pt-20 sm:pt-32 md:pt-44 pb-12 sm:pb-16 md:pb-24 overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center sm:text-left">
          ...
          <motion.h1 
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-text-primary mb-4 sm:mb-6 leading-tight"
          >
            {title}
          </motion.h1>
          ...
          <motion.div 
            ...
            className="h-1 bg-primary/30 rounded-full mt-6 sm:mt-12"
          ></motion.div>
        </div>
      </div>
    </div>
